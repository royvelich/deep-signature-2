...
class QuadraticMonagePatchGenerator2(PatchGenerator):
    ...
    def generate(self, k1=0, k2=0,grid_size_delta=0, downsample=True) -> Patch:
        ...
        return Patch(x_grid=x_grid, y_grid=y_grid, z_grid=z_grid, downsample=downsample), k1, k2,point0_0_index
