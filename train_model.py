...
def main_loop():
    ...
    if torch.cuda.is_available():
        ...
        file_path = server_dir+"data/spherical_monge_patches_100_N_3000.pkl"
        file_path2 = server_dir+"data/hyperbolic_monge_patches_100_N_3000.pkl"
        file_path3 = server_dir+"data/parabolic_monge_patches_100_N_3000.pkl"
        num_workers = 1
